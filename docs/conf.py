...
# -*- coding: utf-8 -*-
#
# afmformats documentation build configuration file, created by
...
# Get version number from afmformats._version file
...
rst_prolog = """
:github_url: https://github.com/AFM-Analysis/afmformats
"""
...
bibtex_bibfiles = ['afmformats.bib']
...
# This gets 'version'
exec(open(op.join(pdir, "afmformats/_version.py")).read())
...
htmlhelp_basename = 'afmformatsdoc'
...
latex_documents = [
    (master_doc, 'afmformats.tex', 'afmformats Documentation',
     'Paul Müller', 'manual'),
]
...
man_pages = [
    (master_doc, 'afmformats', 'afmformats Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'afmformats', 'afmformats Documentation',
     author, 'afmformats', 'Loading AFM nanoindentation data',
     'Scientific'),
]
